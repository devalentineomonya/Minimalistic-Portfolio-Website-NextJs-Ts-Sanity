...
export default function HireMePage() {
  ...
  const { ref, inView } = useReusableInView();
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <motion.div variants={itemVariants}>
              <input
                ...
                required
                className="w-full bg-zinc-100 inset-1 dark:bg-[#373737] outline-none border border-[#e6e6e6]
                 dark:border-[#424242] rounded-md p-3 text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-500
                 focus:ring-1 focus:ring-zinc-500 dark:focus:ring-zinc-300 transition-all"
              />
            </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <motion.button
              type="submit"
              className="isolate relative w-full flex items-center space-x-2 bg-black
              dark:bg-[#373737] text-white px-4 py-4 rounded-md text-sm
               shadow-[0px_8px_16px_0px_rgba(22,_22,_22,_0),_0px_1px_1px_0px_rgba(23,_23,_23,_0.1),_inset_0px_-1px_1px_0px_var(rgba(204,_204,_204,_.1),_rgb(77,_77,_77)),_0px_0px_0px_5px_var(rgba(0,_0,_0,_0.16),rgba(0,_0,_0,_0.1))] justify-center"
